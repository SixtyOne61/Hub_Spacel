...
void AHub_SpacelPawn::NotifyHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AHub_SpacelPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AHub_SpacelPawn::MoveUpInput(float Val)
{
...
void AHub_SpacelPawn::MoveRightInput(float Val)
{
